...
/**
 * Lang strings for tb_c_courses block
 *
...
$string['tb_c_courses:addinstance'] = 'Add a new Leeloo LXP Completed Courses block';
$string['tb_c_courses:myaddinstance'] = 'Add a new Leeloo LXP Completed Courses block to Dashboard';
$string['defaultmaxcourses'] = 'Default maximum courses';
$string['defaultmaxcoursesdesc'] = 'Maximum courses which should be displayed on Leeloo LXP Completed Courses block, 0 will show all courses';
...
$string['pluginname'] = 'Leeloo LXP Completed Courses';
$string['displayname'] = 'Leeloo LXP Completed Courses';
...
$string['tb_c_courses_bgimage'] = "Embed images into background";
$string['tb_c_courses_bgimage_desc'] = "This will embed images into background as a CSS property";
...
$string['privacy:metadata'] = 'The Leeloo LXP Completed Courses (tb_c_courses) block only shows information about courses and does not store data itself.';
