...
/**
 * Move/order course functionality for tb_c_courses block.
 *
...
list($courses, $sitecourses, $coursecount) = block_tb_c_courses_get_sorted_courses();
...
block_tb_c_courses_update_myorder(array_values($neworder));
redirect(new moodle_url('/my/index.php'));
